...
import { Badge, Button, Card, CardLabel, CardTitle, EmptyState, Input, PageHeader, SegmentedControl, SectionHeader, Kicker, Pill, PressableScale } from '../../components/ui'
  ...
  function renderChatItem({ item }) {
    return (
      <PressableScale
        ...
        haptic="light"
      >
        <View style={[styles.chatRow, { backgroundColor: theme.bg.card, borderColor: theme.border }]}>
